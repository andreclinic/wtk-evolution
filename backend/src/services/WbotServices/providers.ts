                                  ...
                                  axios
                                    ...
                                    .then(async function (response) {
                                      ...
                                      if (
                                        ...
                                        console.log("body:", bodycodigoBarras);
                                        await wbot.sendMessage(
                                          `${ticket.contact.number}@${
                                            ticket.isGroup
                                              ? "g.us"
                      ...
                      axios
                        ...
                        .then(async function (response) {
                          ...
                          if (tipo === "success") {
                            ...
                            console.log("body:", bodyBoletoPix);
                            await wbot.sendMessage(
                              `${ticket.contact.number}@${
                                ticket.isGroup ? "g.us" : "s.whatsapp.net"
                              }`,
                            ...
                            console.log("body:", body_linhadigitavel);
                            await wbot.sendMessage(
                              `${ticket.contact.number}@${
                                ticket.isGroup ? "g.us" : "s.whatsapp.net"
                              }`,
                            ...
                            console.log("body:", body_linha_digitavel);
                            await wbot.sendMessage(
                              `${ticket.contact.number}@${
                                ticket.isGroup ? "g.us" : "s.whatsapp.net"
                              }`,
                                  ...
                                  axios
                                    ...
                                    .then(async function (response) {
                                      ...
                                      if (tipo === "sucesso") {
                                        ...
                                        console.log("body:", msg_errolbieracao);
                                        await wbot.sendMessage(
                                          `${ticket.contact.number}@${
                                            ticket.isGroup
                                              ? "g.us"
                                        ...
                                        console.log("body:", bodyerroatendent);
                                        await wbot.sendMessage(
                                          `${ticket.contact.number}@${
                                            ticket.isGroup
                                              ? "g.us"
              ...
              .then(async function (response) {
                ...
                if (response.data.total === 0) {
                        ...
                        axios
                          ...
                          .then(async function (response) {
                            ...
                            if (tipo === "sucesso") {
                              ...
                              axios
                                ...
                                .then(async function (response) {
                                  ...
                                  if (tipo === "success") {
                                    ...
                                    console.log("body:", body_mensagem);
                                    await wbot.sendMessage(
                                      `${ticket.contact.number}@${
                                        ticket.isGroup
                                          ? "g.us"
                              ...
                              console.log("body:", bodyerroatendente);
                              await wbot.sendMessage(
                                `${ticket.contact.number}@${
                                  ticket.isGroup ? "g.us" : "s.whatsapp.net"
                                }`,
                  ...
                  text: formatBody(`Ops! Ocorreu um erro e nao consegui desbloquear! Digite *#* e fale com um atendente!`
                        ...
                        console.log("body:", bodysembloqueio);
                        await wbot.sendMessage(
                          `${ticket.contact.number}@${
                            ticket.isGroup ? "g.us" : "s.whatsapp.net"
                          }`,
