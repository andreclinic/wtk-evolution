...
export const sendMessageImage = async (
  ...
  let sentMessage;
  try {
    console.log("wbotMessageListener.ts - 282");
    console.log(
      "number:",
    ...
    console.log("wbotMessageListener.ts - 307");
    console.log(
      "number:",
      `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
    );
    console.log(
      "body:",
      formatBody("Não consegui enviar o PDF, tente novamente!", contact)
    );
    sentMessage = await wbot.sendMessage(
      `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`,
      {
...
export const sendMessageLink = async (
  ...
  let sentMessage;
  try {
    console.log("wbotMessageListener.ts - 335");
    console.log(
      "number:",
      `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
    );
    ...
    console.log("wbotMessageListener.ts - 359");
    console.log(
      "number:",
      `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
    );
    ...
    console.log("wbotMessageListener.ts - 384");
    console.log(
      "number:",
      `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
    );
    ...
    console.log("wbotMessageListener.ts - 404");
    console.log(
      "number:",
      `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
    );
...
const handleOpenAi = async (
  ...
  if (msg.message?.conversation || msg.message?.extendedTextMessage?.text) {
    ...
    if (prompt.voice === "texto") {
      ...
      console.log("wbotMessageListener.ts - 833");
      console.log("number:", msg.key.remoteJid!);
      ...
      convertTextToSpeechAndSaveToFile(
        ...
        try {
          console.log("responseVoice", response);
          console.log("wbotMessageListener.ts - 852");
          console.log("number:", msg.key.remoteJid!);
          console.log("body:", {
    ...
    if (prompt.voice === "texto") {
      ...
      console.log("responseVoice", response);
      console.log("wbotMessageListener.ts - 907");
      console.log("number:", msg.key.remoteJid!);
      console.log("body:", response!);
      const sentMessage = await wbot.sendMessage(msg.key.remoteJid!, {
        text: response!
      ...
      convertTextToSpeechAndSaveToFile(
        ...
        try {
          console.log("wbotMessageListener.ts - 925");
          console.log("number:", msg.key.remoteJid!);
          console.log("body:", {
            audio: { url: `${publicFolder}/${fileNameWithOutExtension}.mp3` },
            mimetype: "audio/mpeg",
...
const verifyQueue = async (
  ...
  if (queues.length === 1) {
    ...
    if (
      ...
      console.log("wbotMessageListener.ts - 1188");
      console.log("number:", msg.key.remoteJid!);
  ...
  const botText = async () => {
    ...
    if (
      ...
      console.log("wbotMessageListener.ts - 1281");
      console.log(
        "number:",
        `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
      );
      ...
      console.log("wbotMessageListener.ts - 1298");
      console.log(
        "number:",
        `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
      );
    ...
    if (choosenQueue.options.length === 0) {
      ...
      if (
        ...
        if (now.isBefore(startTime) || now.isAfter(endTime)) {
          ...
          console.log("wbotMessageListener.ts - 1360");
          console.log(
            "number:",
            `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
          );
      ...
      if (choosenQueue.greetingMessage) {
        ...
        console.log("wbotMessageListener.ts - 1419");
        console.log(
          "number:",
          `${contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
        );
      ...
      if (choosenQueue.mediaPath !== null && choosenQueue.mediaPath !== "") {
        ...
        console.log("wbotMessageListener.ts - 1440");
        console.log(
          "number:",
...
const handleChartbot = async (
  ...
  if (!isNil(queue) && isNil(ticket.queueOptionId)) {
    ...
    const botButton = async () => {
      ...
      console.log("wbotMessageListener.ts - 1719");
      console.log(
        "number:",
        `${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
      );
      // console.log("body:", buttonMessage);
      console.log("wbotMessageListener.ts - 1725");
      console.log(
        "number:",
        `${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
      );
    ...
    const botText = async () => {
      ...
      console.log("wbotMessageListener.ts - 1752");
      console.log(
        "number:",
        `${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
      );
    ...
    if (queueOptions.length === 0) {
      ...
      console.log("wbotMessageListener.ts - 1805");
      console.log(
        "number:",
        `${ticket.contact.number}@${ticket.isGroup ? "g.us" : "s.whatsapp.net"}`
      );
      ...
      if (currentOption.mediaPath !== null && currentOption.mediaPath !== "") {
        ...
        console.log("wbotMessageListener.ts - 1825");
        console.log(
          "number:",
          `${ticket.contact.number}@${
            ticket.isGroup ? "g.us" : "s.whatsapp.net"
    ...
    if (queueOptions.length > -1) {
      ...
      const botList = async () => {
        ...
        console.log("wbotMessageListener.ts - 1887");
        console.log(
          "number:",
          `${ticket.contact.number}@${
            ticket.isGroup ? "g.us" : "s.whatsapp.net"
      ...
      const botButton = async () => {
        ...
        console.log("wbotMessageListener.ts - 1926");
        console.log(
          "number:",
          `${ticket.contact.number}@${
            ticket.isGroup ? "g.us" : "s.whatsapp.net"
      ...
      const botText = async () => {
        ...
        console.log("wbotMessageListener.ts - 1960");
        console.log(
          "number:",
          `${ticket.contact.number}@${
            ticket.isGroup ? "g.us" : "s.whatsapp.net"
        ...
        if (
          ...
          console.log("wbotMessageListener.ts - 1986");
          console.log(
            "number:",
            `${ticket.contact.number}@${
              ticket.isGroup ? "g.us" : "s.whatsapp.net"
  ...
  try {
    ...
    try {
      if (!msg.key.fromMe && scheduleType) {
        ...
        if (
          ...
          const debouncedSentMessage = debounce(
            async () => {
              console.log("wbotMessageListener.ts - 2256");
              console.log(
                "number:",
                `${ticket.contact.number}@${
                  ticket.isGroup ? "g.us" : "s.whatsapp.net"
      ...
      if (!msg.key.fromMe && scheduleType && ticket.queueId !== null) {
        ...
        if (
          ...
          if (now.isBefore(startTime) || now.isAfter(endTime)) {
            ...
            const debouncedSentMessage = debounce(
              async () => {
                console.log("wbotMessageListener.ts - 2480");
                console.log(
                  "number:",
                  `${ticket.contact.number}@${
                    ticket.isGroup ? "g.us" : "s.whatsapp.net"
    ...
    if (
      ...
      if (whatsapp.greetingMessage) {
        ...
        const debouncedSentMessage = debounce(
          async () => {
            console.log("wbotMessageListener.ts - 2532");
            console.log(
              "number:",
              `${ticket.contact.number}@${
                ticket.isGroup ? "g.us" : "s.whatsapp.net"
            ...
            console.log("body:", whatsapp.greetingMessage);
            await wbot.sendMessage(
              `${ticket.contact.number}@${
                ticket.isGroup ? "g.us" : "s.whatsapp.net"
              }`,
