  ...
  try {
    ...
    if (body !== typebotKeywordFinish && body !== typebotKeywordRestart) {
      ...
      if (messages?.length === 0) {
        console.log("typebotListener.ts - 142");
        console.log("body:", typebotUnknownMessage);
        console.log("chatId:", `${number}@c.us`);
        ...
        for (const message of messages) {
          if (message.type === "text") {
            ...
            console.log("typebotListener.ts - 305");
            console.log("body:", formattedText);
            console.log("chatId:", msg.key.remoteJid);
          ...
          if (message.type === "audio") {
            ...
            console.log("typebotListener.ts - 325");
            console.log("body-media:", media);
            console.log("chatId:", msg.key.remoteJid);
          ...
          if (message.type === "image") {
            ...
            console.log("typebotListener.ts - 357");
            console.log("body-media:", media);
            console.log("chatId:", msg.key.remoteJid);
            await wbot.sendMessage(msg.key.remoteJid, media);
            await wbot.sendMessage(msg.key.remoteJid, media);
        ...
        if (input) {
          if (input.type === "choice input") {
            ...
            await delay(typebotDelayMessage);
            await wbot.sendPresenceUpdate("paused", msg.key.remoteJid);
            console.log("typebotListener.ts - 393");
            console.log("body:", formattedText);
            console.log("chatId:", msg.key.remoteJid);
            await wbot.sendMessage(msg.key.remoteJid, { text: formattedText });
          }
    ...
    if (body === typebotKeywordRestart) {
      ...
      console.log("typebotListener.ts - 408");
      console.log("body:", typebotRestartMessage);
      console.log("chatId:", `${number}@c.us`);
